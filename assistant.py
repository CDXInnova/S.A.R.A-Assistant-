...
openai.api_key = "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"
...
def abrir_en_vscode(archivo):
    ...
    try:
        subprocess.run(["code", archivo_lower])  # Usar archivo_lower en lugar de archivo  # noqa: E501
    except Exception as e:
...
def mostrar_hora():
    ...
    hablar("La hora actual es " + current_time)
...
def main():
    ...
    while True:
        ...
        if time_since_last_interaction.total_seconds() > 150:
            mostrar_hora()
            hacer_comentario_positivo()
